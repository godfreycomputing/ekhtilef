...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} วันที่ผ่านมา";

  static String m2(total) => "~${total} กม.";

  static String m3(timeLeft) => "Ends in ${timeLeft}";

  static String m4(message) => "ข้อผิดพลาด: ${message}";

  static String m5(time) => "จะหมดอายุใน ${time}";

  static String m6(total) => ">${total} กม.";

  static String m7(hour) => "${hour} ชั่วโมงที่ผ่านมา";
  ...
  static String m9(size) => "ขนาดไฟล์สูงสุด: ${size} MB";

  static String m10(minute) => "{นาที} นาทีที่ผ่านมา";

  static String m11(month) => "${month} เดือนที่แล้ว";

  static String m12(itemCount) => "${itemCount} รายการ";

  static String m13(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m14(percent) => "ยอดขาย ${percent} %";

  static String m15(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m18(total) => "${total} สินค้า";

  static String m19(date) => "ใช้ได้จนถึง ${date}";

  static String m20(message) => "คำเตือน: ${message}";

  static String m21(length) => "เราพบสินค้า ${length}";

  static String m22(week) => "สัปดาห์ ${week}";

  static String m23(year) => "${year} ปีที่แล้ว";

  static String m24(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
