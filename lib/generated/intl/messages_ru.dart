...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} дней назад";
  ...
  static String m5(time) => "Срок действия истекает через ${time}";

  static String m6(total) => ">${total} км";

  static String m7(hour) => "${hour} часов назад";
  ...
  static String m9(size) => "Максимальный размер файла: ${size} МБ";

  static String m10(minute) => "${minute} минут назад";

  static String m11(month) => "${month} месяцев назад";

  static String m12(itemCount) => "${itemCount} товаров";

  static String m13(price) => "Всего вариантов: ${price}";

  static String m14(percent) => "Распродажа ${percent} %";

  static String m15(second) => "${second} секунд назад";
  ...
  static String m18(total) => "${total} продуктов";

  static String m19(date) => "Действительно до ${date}";

  static String m20(message) => "Предупреждение: ${message}";

  static String m21(length) => "Мы нашли товары";

  static String m22(week) => "Неделя ${week}";

  static String m23(year) => "${year} лет назад";

  static String m24(total) => "Вы назначили заказ №${total}";
