...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(time) => " ${time}で期限切れ";
  ...
  static String m9(size) => "最大ファイルサイズ： ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => "${month} か月前";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "オプションの合計： ${price}";

  static String m14(percent) => "セール${percent}％";
  ...
  static String m18(total) => "${total} 製品";

  static String m19(date) => " ${date}まで有効";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "${length} 個の商品が見つかりました";

  static String m22(week) => "週 ${week}";

  static String m23(year) => "${year} 年前";

  static String m24(total) => "注文番号${total}に割り当てました";
