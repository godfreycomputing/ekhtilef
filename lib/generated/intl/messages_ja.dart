...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(size) => "最大ファイルサイズ： ${size} MB";

  static m10(minute) => "${minute} minutes ago";

  static m11(month) => "${month} か月前";

  static m12(itemCount) => "${itemCount} items";

  static m13(price) => "オプションの合計： ${price}";

  static m14(percent) => "セール${percent}％";
  ...
  static m18(total) => "${total} 製品";

  static m19(date) => " ${date}まで有効";

  static m20(message) => "Warning: ${message}";

  static m21(length) => "${length} 個の商品が見つかりました";

  static m22(week) => "週 ${week}";

  static m23(year) => "${year} 年前";

  static m24(total) => "注文番号${total}に割り当てました";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "atLeastThreeCharacters" : MessageLookupByLibrary.simpleMessage("少なくとも3文字..."),
    "attributes" : MessageLookupByLibrary.simpleMessage("の属性"),
    "audioDetected" : MessageLookupByLibrary.simpleMessage("オーディオアイテムが検出されました。オーディオプレーヤーに追加しますか？"),
    ...
    "cantPickDateInThePast" : MessageLookupByLibrary.simpleMessage("過去の日付は許可されていません"),
    ...
    "chatViaFacebook" : MessageLookupByLibrary.simpleMessage("Facebookメッセンジャー経由でチャット"),
    "chatViaWhatApp" : MessageLookupByLibrary.simpleMessage("WhatsApp経由でチャット"),
    "chatWithStoreOwner" : MessageLookupByLibrary.simpleMessage("ストアオーナーとチャットする"),
    ...
    "commentSuccessfully" : MessageLookupByLibrary.simpleMessage("コメントに成功しました。コメントが承認されるまでお待ちください"),
    "confirm" : MessageLookupByLibrary.simpleMessage("確認"),
    "confirmClearTheCart" : MessageLookupByLibrary.simpleMessage("カートをクリアしてもよろしいですか？"),
    "confirmDeleteItem" : MessageLookupByLibrary.simpleMessage("このアイテムを削除してもよろしいですか？"),
    ...
    "createNewPostSuccessfully" : MessageLookupByLibrary.simpleMessage("投稿は下書きとして正常に作成されました。管理サイトをご覧ください。"),
    ...
    "deliveryNotificationError" : MessageLookupByLibrary.simpleMessage("データなし。\nこの注文は削除されました。"),
    ...
    "emailDoesNotExist" : MessageLookupByLibrary.simpleMessage("入力したメールアカウントは存在しません。もう一度やり直してください。"),
    ...
    "emptySearch" : MessageLookupByLibrary.simpleMessage("まだアイテムを検索していません。今から始めましょう-私たちはあなたを助けます。"),
    ...
    "endDateCantBeAfterFirstDate" : MessageLookupByLibrary.simpleMessage("最初のデートの後のデートを選択してください"),
    "endsIn" : m3,
    ...
    "enterYourEmailOrUsername" : MessageLookupByLibrary.simpleMessage("メールアドレスまたはユーザー名を入力してください"),
    ...
    "error" : m4,
    "errorEmailFormat" : MessageLookupByLibrary.simpleMessage("有効なメールアドレスを入力してください。"),
    "errorPasswordFormat" : MessageLookupByLibrary.simpleMessage("8文字以上のパスワードを入力してください"),
    ...
    "loginToComment" : MessageLookupByLibrary.simpleMessage("コメントするにはログインしてください"),
    ...
    "noFileToDownload" : MessageLookupByLibrary.simpleMessage("ダウンロードするファイルがありません。"),
    ...
    "phoneHintFormat" : MessageLookupByLibrary.simpleMessage("フォーマット：+84123456789"),
    ...
    "pleaseSignInBeforeUploading" : MessageLookupByLibrary.simpleMessage("ファイルをアップロードする前に、アカウントにサインインしてください。"),
    ...
    "postSuccessfully" : MessageLookupByLibrary.simpleMessage("あなたの投稿は正常に作成されました"),
    ...
    "productCreateReview" : MessageLookupByLibrary.simpleMessage("レビュー後に商品が表示されます。"),
    ...
    "refundOrderFailed" : MessageLookupByLibrary.simpleMessage("注文の払い戻しのリクエストは失敗しました"),
    "refundOrderSuccess" : MessageLookupByLibrary.simpleMessage("ご注文の払い戻しを正常にリクエストしてください。"),
    ...
    "relatedLayoutTitle" : MessageLookupByLibrary.simpleMessage("あなたが好きかもしれないもの"),
    ...
    "requestTooMany" : MessageLookupByLibrary.simpleMessage("短時間にリクエストしたコードが多すぎます。後でもう一度やり直してください。"),
    ...
    "userExists" : MessageLookupByLibrary.simpleMessage("このユーザー名/メールアドレスは利用できません。"),
    ...
    "youCanOnlyOrderSingleStore" : MessageLookupByLibrary.simpleMessage("購入できるのは1店舗のみです。"),
