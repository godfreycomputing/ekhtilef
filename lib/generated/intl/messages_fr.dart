...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "il y a ${day} jours";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Ends in ${timeLeft}";

  static String m4(message) => "Error: ${message}";

  static String m5(time) => "Expirant dans ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "il y a ${hour} heures";
  ...
  static String m9(size) => "Taille maximale du fichier: ${size} Mo";

  static String m10(minute) => "il y a ${minute} minutes";

  static String m11(month) => " Il y a${month} mois";

  static String m12(itemCount) => "${itemCount} produits";

  static String m13(price) => "Total des options: ${price}";

  static String m14(percent) => "Vente ${percent} %";

  static String m15(second) => "il y a ${second} secondes";

  static String m16(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} produits";

  static String m17(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m18(total) => "${total} Produits";

  static String m19(date) => "Valable jusqu\'au ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "Nous avons trouvé des ${length} produits";

  static String m22(week) => "Semaine ${week}";

  static String m23(year) => " Il y a${year} ans";

  static String m24(total) => "Vous avez affecté à la commande n°${total}";
