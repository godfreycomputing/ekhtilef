...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(time) => "Caduca en ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour}  horas";
  ...
  static String m9(size) => "Tamaño máximo de archivo: ${size} MB";

  static String m10(minute) => "${minute} minutos";

  static String m11(month) => " Hace${month} meses";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Total de opciones: ${price}";

  static String m14(percent) => "Rebaja ${percent} %";

  static String m15(second) => "${second} segundos";
  ...
  static String m18(total) => "${total} Productos";

  static String m19(date) => "Válido hasta ${date}";

  static String m20(message) => "Advertencia: ${message}";

  static String m21(length) => "Encontramos productos de ${length}";

  static String m22(week) => "Semana ${week}";

  static String m23(year) => " Hace${year} años";

  static String m24(total) => "Ha asignado a la orden #${total}";
