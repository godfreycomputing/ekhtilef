...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} napja";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Ends in ${timeLeft}";

  static String m4(message) => "Hiba: ${message}";

  static String m5(time) => "Lejárat ideje: ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} órája";
  ...
  static String m9(size) => "Maximális fájlméret: ${size} MB";

  static String m10(minute) => "${minute} perce";

  static String m11(month) => "${month} hónappal ezelőtt";

  static String m12(itemCount) => "${itemCount} termékek";

  static String m13(price) => "Opciók összesen: ${price}";

  static String m14(percent) => "${percent} % Kedvezmény";

  static String m15(second) => "${second} másodperce";
  ...
  static String m18(total) => "${total} termék";

  static String m19(date) => "Érvényes: ${date}";

  static String m20(message) => "Figyelmeztetés: ${message}";

  static String m21(length) => "Találtunk ${length} terméket";

  static String m22(week) => " ${week}hét";

  static String m23(year) => "${year} évvel ezelőtt";

  static String m24(total) => "Hozzárendelte a (z)${total}számú megrendelést";
