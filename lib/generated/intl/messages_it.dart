...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(message) => "Errore: ${message}";

  static String m5(time) => "In scadenza tra ${time}";
  ...
  static String m9(size) => "Dimensione massima del file: ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => "${month} mesi fa";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Opzioni totali: ${price}";

  static String m14(percent) => "${percent}% di sconto";
  ...
  static String m18(total) => "${total} Prodotti";

  static String m19(date) => "Valido fino alle ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "Abbiamo trovato \$length prodotti";

  static String m22(week) => "Settimana ${week}";

  static String m23(year) => "${year} anni fa";

  static String m24(total) => "Hai assegnato all\'ordine #${total}";
