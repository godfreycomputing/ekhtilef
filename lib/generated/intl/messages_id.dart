...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(message) => "Galat: ${message}";

  static String m5(time) => "Kedaluwarsa dalam ${time}";
  ...
  static String m9(size) => "Ukuran file maksimum: ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => "${month} bulan yang lalu";

  static String m12(itemCount) => "${itemCount} barang";

  static String m13(price) => "Total opsi: ${price}";

  static String m14(percent) => "Diskon ${percent} %";
  ...
  static String m18(total) => "${total} produk";

  static String m19(date) => "Berlaku sampai ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "Kami menemukan produk ${length}";

  static String m22(week) => "Minggu ${week}";

  static String m23(year) => "${year} tahun lalu";

  static String m24(total) => "Anda telah menetapkan untuk memesan #${total}";
