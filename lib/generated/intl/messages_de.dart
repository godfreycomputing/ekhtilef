...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "Vor ${day} Tagen";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Endet in ${timeLeft}";

  static String m4(message) => "Fehler: ${message}";

  static String m5(time) => "Ablaufen in ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "Vor ${hour} Stunden";
  ...
  static String m9(size) => "Maximale Dateigröße: ${size} MB";

  static String m10(minute) => "Vor ${minute} Minuten";

  static String m11(month) => " Vor${month} Monaten";

  static String m12(itemCount) => "${itemCount} Artikel";

  static String m13(price) => "Optionen insgesamt: ${price}";

  static String m14(percent) => "Ausverkauf ${percent} %";

  static String m15(second) => "Vor ${second} Sekunden";

  static String m16(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m17(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m18(total) => "${total} Produkte";

  static String m19(date) => "Gültig bis ${date}";

  static String m20(message) => "Warnung: ${message}";

  static String m21(length) => "Wir haben die Produkte gefunden";

  static String m22(week) => "Woche ${week}";

  static String m23(year) => " Vor${year} Jahren";

  static String m24(total) => "Sie haben der Bestellung #${total}zugewiesen";
