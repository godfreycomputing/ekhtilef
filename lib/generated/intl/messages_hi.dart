...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(total) => "~${total} किमी";

  static m3(timeLeft) => " ${timeLeft}में समाप्त होता है";

  static m4(message) => "त्रुटि: ${message}";

  static m5(time) => " ${time}में समाप्त हो रहा है";

  static m6(total) => ">${total} किमी";

  static m7(hour) => "${hour} घंटे पहले";

  static m8(message) => "डेटा के अनुरोध के दौरान एप्लिकेशन के साथ एक समस्या है, कृपया मुद्दों को ठीक करने के लिए व्यवस्थापक से संपर्क करें: ${message}";

  static m9(size) => "अधिकतम फ़ाइल आकार: ${size} एमबी";

  static m10(minute) => "${minute} मिनट पहले";

  static m11(month) => "${month} महीने पहले";

  static m12(itemCount) => "${itemCount} आइटम";

  static m13(price) => "विकल्प कुल: ${price}";

  static m14(percent) => "बिक्री ${percent} %";

  static m15(second) => "${second} सेकंड पहले";

  static m16(totalCartQuantity) => "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static m17(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static m18(total) => "${total} उत्पाद";

  static m19(date) => "मान्य तिल ${date}";

  static m20(message) => "चेतावनी: ${message}";

  static m21(length) => "हमें ${length} उत्पाद मिले";

  static m22(week) => "सप्ताह ${week}";

  static m23(year) => "${year} साल पहले";

  static m24(total) => "आपने #${total}ऑर्डर करने के लिए असाइन किया है";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "addToCartMaximum" : MessageLookupByLibrary.simpleMessage("अधिकतम मात्रा पार हो गई है"),
    ...
    "atLeastThreeCharacters" : MessageLookupByLibrary.simpleMessage("कम से कम 3 अक्षर..."),
    "attributes" : MessageLookupByLibrary.simpleMessage("गुण"),
    "audioDetected" : MessageLookupByLibrary.simpleMessage("ऑडियो आइटम का पता चला है। क्या आप ऑडियो प्लेयर में जोड़ना चाहते हैं?"),
    ...
    "bannerYoutubeURL" : MessageLookupByLibrary.simpleMessage("बैनर यूट्यूब यूआरएल"),
    ...
    "cantPickDateInThePast" : MessageLookupByLibrary.simpleMessage("अतीत में तारीख की अनुमति नहीं है"),
    ...
    "chatViaFacebook" : MessageLookupByLibrary.simpleMessage("फेसबुक मैसेंजर के जरिए चैट करें"),
    "chatViaWhatApp" : MessageLookupByLibrary.simpleMessage("व्हाट्सएप के जरिए चैट करें"),
    "chatWithStoreOwner" : MessageLookupByLibrary.simpleMessage("स्टोर मालिक के साथ चैट करें"),
    ...
    "confirmClearTheCart" : MessageLookupByLibrary.simpleMessage("क्या आप वाकई कार्ट साफ़ करना चाहते हैं?"),
    "confirmDeleteItem" : MessageLookupByLibrary.simpleMessage("क्या आप वाकई इस आइटम को हटाना चाहते हैं?"),
    ...
    "deliveryNotificationError" : MessageLookupByLibrary.simpleMessage("कोई आकड़ा उपलब्ध नहीं है।\nयह आदेश हटा दिया गया है।"),
    ...
    "disablePurchase" : MessageLookupByLibrary.simpleMessage("खरीदारी अक्षम करें"),
    ...
    "emailDoesNotExist" : MessageLookupByLibrary.simpleMessage("आपके द्वारा दर्ज किया गया ईमेल खाता मौजूद नहीं है। कृपया पुन: प्रयास करें।"),
    ...
    "enableVacationMode" : MessageLookupByLibrary.simpleMessage("अवकाश मोड सक्षम करें"),
    "endDateCantBeAfterFirstDate" : MessageLookupByLibrary.simpleMessage("कृपया पहली तारीख के बाद की तारीख चुनें"),
    "endsIn" : m3,
    ...
    "enterYourEmailOrUsername" : MessageLookupByLibrary.simpleMessage("अपना ईमेल या उपयोगकर्ता नाम दर्ज करें"),
    "enterYourFirstName" : MessageLookupByLibrary.simpleMessage("अपना पहला नाम दर्ज करें"),
    "enterYourLastName" : MessageLookupByLibrary.simpleMessage("अपना अंतिम नाम दर्ज करें"),
    "enterYourMobile" : MessageLookupByLibrary.simpleMessage("अपना मोबाइल नंबर दर्ज करें"),
    "enterYourPassword" : MessageLookupByLibrary.simpleMessage("अपना पासवर्ड डालें"),
    "enterYourPhoneNumber" : MessageLookupByLibrary.simpleMessage("अपना दूरभाष क्रमांक दर्ज करें"),
    "error" : m4,
    "errorEmailFormat" : MessageLookupByLibrary.simpleMessage("कृपया एक वैध ई - मेल एड्रेस डालें।"),
    "errorPasswordFormat" : MessageLookupByLibrary.simpleMessage("कृपया कम से कम 8 वर्णों का एक पासवर्ड दर्ज करें"),
    ...
    "firstComment" : MessageLookupByLibrary.simpleMessage("इस पोस्ट पर टिप्पणी करने वाले पहले व्यक्ति बनें!"),
    ...
    "loginInvalid" : MessageLookupByLibrary.simpleMessage("आपको इस ऐप का उपयोग करने की अनुमति नहीं है।"),
    "loginSuccess" : MessageLookupByLibrary.simpleMessage("सफलतापूर्वक लॉगिन करें!"),
    ...
    "markAsShipped" : MessageLookupByLibrary.simpleMessage("शिप किया गया के रूप में चिह्नित करें"),
    "markAsUnread" : MessageLookupByLibrary.simpleMessage("अपठित के रूप में चिह्नित करें"),
    ...
    "minutesAgo" : m10,
    "mobileVerification" : MessageLookupByLibrary.simpleMessage("मोबाइल सत्यापन"),
    ...
    "noFileToDownload" : MessageLookupByLibrary.simpleMessage("डाउनलोड करने के लिए कोई फ़ाइल नहीं।"),
    ...
    "noListingNearby" : MessageLookupByLibrary.simpleMessage("आस-पास कोई लिस्टिंग नहीं!"),
    ...
    "orderStatusCanceledReversal" : MessageLookupByLibrary.simpleMessage("लेनदेन वापसी रद्द की गई"),
    ...
    "orderStatusExpired" : MessageLookupByLibrary.simpleMessage("समय सीमा समाप्त"),
    ...
    "phoneHintFormat" : MessageLookupByLibrary.simpleMessage("प्रारूप: +84123456789"),
    ...
    "pleaseSignInBeforeUploading" : MessageLookupByLibrary.simpleMessage("कोई भी फ़ाइल अपलोड करने से पहले कृपया अपने खाते में साइन इन करें।"),
    ...
    "postFail" : MessageLookupByLibrary.simpleMessage("आपकी पोस्ट बनने में विफल है"),
    ...
    "postSuccessfully" : MessageLookupByLibrary.simpleMessage("आपकी पोस्ट सफलतापूर्वक बना दी गई है"),
    ...
    "productCreateReview" : MessageLookupByLibrary.simpleMessage("आपका उत्पाद समीक्षा के बाद दिखाई देगा।"),
    ...
    "refundOrderFailed" : MessageLookupByLibrary.simpleMessage("आदेश के लिए धनवापसी का अनुरोध असफल रहा"),
    "refundOrderSuccess" : MessageLookupByLibrary.simpleMessage("सफलतापूर्वक अपने आदेश के लिए धनवापसी का अनुरोध करें!"),
    ...
    "registerSuccess" : MessageLookupByLibrary.simpleMessage("सफलतापूर्वक पंजीकरण करें"),
    "regularPrice" : MessageLookupByLibrary.simpleMessage("नियमित रूप से मूल्य"),
    "relatedLayoutTitle" : MessageLookupByLibrary.simpleMessage("चीजें जो आपको पसंद आ सकती हैं"),
    ...
    "requestTooMany" : MessageLookupByLibrary.simpleMessage("आपने कम समय में बहुत अधिक कोड का अनुरोध किया है। बाद में पुन: प्रयास करें।"),
    ...
    "storeMobileBanner" : MessageLookupByLibrary.simpleMessage("स्टोर मोबाइल बैनर"),
    "storeSettings" : MessageLookupByLibrary.simpleMessage("स्टोर सेटिंग्स"),
    "storeSliderBanner" : MessageLookupByLibrary.simpleMessage("स्टोर स्लाइडर बैनर"),
    "storeStaticBanner" : MessageLookupByLibrary.simpleMessage("स्टोर स्टेटिक बैनर"),
    ...
    "submitYourPost" : MessageLookupByLibrary.simpleMessage("अपनी पोस्ट सबमिट करें"),
    ...
    "updateFailed" : MessageLookupByLibrary.simpleMessage("भार बढ़ाना विफल हुवा!"),
    "updateInfo" : MessageLookupByLibrary.simpleMessage("जानकारी अद्यतन"),
    "updatePassword" : MessageLookupByLibrary.simpleMessage("पासवर्ड अपडेट करें"),
    "updateStatus" : MessageLookupByLibrary.simpleMessage("नवीनतम स्थिति"),
    "updateSuccess" : MessageLookupByLibrary.simpleMessage("सफलतापूर्वक अपडेट करें!"),
    ...
    "userExists" : MessageLookupByLibrary.simpleMessage("यह उपयोगकर्ता नाम/ईमेल उपलब्ध नहीं है।"),
    ...
    "verificationCode" : MessageLookupByLibrary.simpleMessage("सत्यापन कोड (6 अंक)"),
    ...
    "youCanOnlyOrderSingleStore" : MessageLookupByLibrary.simpleMessage("आप केवल एक ही स्टोर से खरीदारी कर सकते हैं।"),
    ...
    "youNotBeAsked" : MessageLookupByLibrary.simpleMessage("पूरा होने के बाद आपसे अगली बार नहीं पूछा जाएगा"),
