...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} दिन पहले";

  static String m2(total) => "~${total} किमी";

  static String m3(timeLeft) => " ${timeLeft}में समाप्त होता है";

  static String m4(message) => "त्रुटि: ${message}";

  static String m5(time) => " ${time}में समाप्त हो रहा है";

  static String m6(total) => ">${total} किमी";

  static String m7(hour) => "${hour} घंटे पहले";
  ...
  static String m9(size) => "अधिकतम फ़ाइल आकार: ${size} एमबी";

  static String m10(minute) => "${minute} मिनट पहले";

  static String m11(month) => "${month} महीने पहले";

  static String m12(itemCount) => "${itemCount} आइटम";

  static String m13(price) => "विकल्प कुल: ${price}";

  static String m14(percent) => "बिक्री ${percent} %";

  static String m15(second) => "${second} सेकंड पहले";

  static String m16(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m17(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m18(total) => "${total} उत्पाद";

  static String m19(date) => "मान्य तिल ${date}";

  static String m20(message) => "चेतावनी: ${message}";

  static String m21(length) => "हमें ${length} उत्पाद मिले";

  static String m22(week) => "सप्ताह ${week}";

  static String m23(year) => "${year} साल पहले";

  static String m24(total) => "आपने #${total}ऑर्डर करने के लिए असाइन किया है";
