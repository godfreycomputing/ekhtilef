...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m4(message) => "Lỗi: ${message}";

  static String m5(time) => "Hết hạn sau ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} hours ago";
  ...
  static String m9(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => "${month} tháng trước";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Tổng số tùy chọn: ${price}";

  static String m14(percent) => "Sale ${percent} %";

  static String m15(second) => "${second} seconds ago";

  static String m16(totalCartQuantity) =>
      "Shopping cart, ${totalCartQuantity} items";

  static String m17(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m18(total) => "${total} sản phẩm";

  static String m19(date) => "Có hiệu lực cho đến ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m22(week) => "Tuần ${week}";

  static String m23(year) => "${year} năm trước";

  static String m24(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "loading":
            MessageLookupByLibrary.simpleMessage("Đang tải, đừng làm phiền..."),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Những điều bạn có thể yêu"),
        "releaseToLoadMore":
