...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} dagar sedan";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Slutar om ${timeLeft}";

  static String m4(message) => "Fel: ${message}";

  static String m5(time) => "Går ut om ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} timmar sedan";
  ...
  static String m9(size) => "Maximal filstorlek: ${size} MB";

  static String m10(minute) => " För${minute} minuter sedan";

  static String m11(month) => "${month} månader sedan";

  static String m12(itemCount) => "${itemCount} objekt";

  static String m13(price) => "Totalt antal alternativ: ${price}";

  static String m14(percent) => "Försäljning ${percent}%";

  static String m15(second) => " För${second} sekunder sedan";

  static String m16(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m17(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m18(total) => "${total} produkter";

  static String m19(date) => "Gäller till ${date}";

  static String m20(message) => "Varning: ${message}";

  static String m21(length) => "Vi hittade ${length} produkter";

  static String m22(week) => "Vecka ${week}";

  static String m23(year) => " För${year} år sedan";

  static String m24(total) => "Du har tilldelat order nr${total}";
