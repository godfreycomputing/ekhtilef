...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(size) => "Maximum file size: ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => "${month} months ago";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Options total: ${price}";
  ...
  static String m18(total) => "${total} products";

  static String m19(date) => "Valid til ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "We found ${length} products";

  static String m22(week) => "Week ${week}";

  static String m23(year) => "${year} years ago";

  static String m24(total) => "You have assigned to order #${total}";
