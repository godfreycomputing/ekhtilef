...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(time) => "Expiră în ${time}";
  ...
  static String m9(size) => "Dimensiunea maximă a fișierului: ${size} MB";

  static String m10(minute) => "${minute} minutes ago";

  static String m11(month) => " Acum${month} luni";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Opțiuni totale: ${price}";

  static String m14(percent) => "Reducere ${percent} %";
  ...
  static String m18(total) => "${total} produse";

  static String m19(date) => "Valabil până la ${date}";

  static String m20(message) => "Warning: ${message}";

  static String m21(length) => "Am gasit ${length} produse";

  static String m22(week) => "Săptămâna ${week}";

  static String m23(year) => " Acum${year} ani";

  static String m24(total) => "Ați atribuit comenzii nr.${total}";
