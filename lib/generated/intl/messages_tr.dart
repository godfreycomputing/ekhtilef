...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} Gün önce";
  ...
  static String m5(time) => " ${time}içinde süresi doluyor";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} Saat önce";
  ...
  static String m9(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m10(minute) => "${minute} Dakika önce";

  static String m11(month) => "${month} ay önce";

  static String m12(itemCount) => "${itemCount} ürün";

  static String m13(price) => "Toplam seçenek: ${price}";

  static String m14(percent) => "% ${percent} İndirim ";

  static String m15(second) => "${second} Saniye önce";

  static String m16(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m17(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m18(total) => "${total} ürün";

  static String m19(date) => " ${date}tarihine kadar geçerlidir";

  static String m20(message) => "Hata: ${message}";

  static String m21(length) => " \$${length} Ürün Bulundu";

  static String m22(week) => " ${week}haftası";

  static String m23(year) => "${year} yıl önce";

  static String m24(total) => "#${total}numaralı siparişe atadınız";
