...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(day) => "${day} 天前";

  static m2(total) => "~${total} 公里";

  static m3(timeLeft) => "以 ${timeLeft}结尾";

  static m4(message) => "Error: ${message}";

  static m5(time) => "在 ${time}期满";

  static m6(total) => ">${total} 公里";

  static m7(hour) => "${hour} 小时前";

  static m8(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static m9(size) => "档案大小上限： ${size} MB";

  static m10(minute) => "${minute} 分钟钱";

  static m11(month) => "${month} 个月前";

  static m12(itemCount) => "${itemCount} 件商品";

  static m13(price) => "选项总数： ${price}";

  static m14(percent) => "出售${percent}%";

  static m15(second) => "${second} 秒前";

  static m16(totalCartQuantity) => "购物车, ${totalCartQuantity} 件商品";

  static m17(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static m18(total) => "${total} 个产品";

  static m19(date) => "有效期至 ${date}";

  static m20(message) => "警告: ${message}";

  static m21(length) => "我们找到 ${length} 个产品";

  static m22(week) => "周 ${week}";

  static m23(year) => "${year} 年前";

  static m24(total) => "您已指定订单 #${total}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "audioDetected" : MessageLookupByLibrary.simpleMessage("检测到音频项目。您想添加到音频播放器吗？"),
    ...
    "chatViaFacebook" : MessageLookupByLibrary.simpleMessage("通过Facebook Messenger聊天"),
    ...
    "deliveryNotificationError" : MessageLookupByLibrary.simpleMessage("没有数据。\n此订单已被删除。"),
    ...
    "emailDoesNotExist" : MessageLookupByLibrary.simpleMessage("您输入的电子邮件帐户不存在。请再试一遍。"),
    "emailIsRequired" : MessageLookupByLibrary.simpleMessage("电子邮件字段为必填項"),
    "emptyCartSubtitle" : MessageLookupByLibrary.simpleMessage("您似乎还没有在包中添加任何物品。开始购物以填充它。"),
    ...
    "emptyWishlistSubtitle" : MessageLookupByLibrary.simpleMessage("轻按产品旁边的任何一个即可收藏。我们将在这里为您保存！"),
    "enableVacationMode" : MessageLookupByLibrary.simpleMessage("开启假期模式"),
    "endDateCantBeAfterFirstDate" : MessageLookupByLibrary.simpleMessage("请选择第一次约会之后的日期"),
    "endsIn" : m3,
    ...
    "enterYourEmailOrUsername" : MessageLookupByLibrary.simpleMessage("输入您的电子邮件或用户名"),
    ...
    "pleaseSelectAllAttributes" : MessageLookupByLibrary.simpleMessage("请为产品的每个属性选择一个选项"),
    "pleaseSelectRequiredOptions" : MessageLookupByLibrary.simpleMessage("请选择必填选项！"),
    "pleaseSignInBeforeUploading" : MessageLookupByLibrary.simpleMessage("请先登录您的帐户，然后再上传任何文件。"),
    "pleasefillUpAllCellsProperly" : MessageLookupByLibrary.simpleMessage("*请正确填写所有字段"),
    "point" : MessageLookupByLibrary.simpleMessage("点"),
    "pointRewardMessage" : MessageLookupByLibrary.simpleMessage("有将您的积分应用到购物车的折扣规则"),
    ...
    "rateThisAppDescription" : MessageLookupByLibrary.simpleMessage("如果您喜欢这个应用程序，请花一点时间来查看它 !\n它真的对我们有帮助，而且不会超过一分钟。"),
    ...
    "requestTooMany" : MessageLookupByLibrary.simpleMessage("您在短时间内请求了太多代码。请稍后再试。"),
    ...
    "thisPlatformNotSupportWebview" : MessageLookupByLibrary.simpleMessage("此平台不支持 webview"),
    ...
    "youCanOnlyOrderSingleStore" : MessageLookupByLibrary.simpleMessage("您只能从一家商店购买。"),
