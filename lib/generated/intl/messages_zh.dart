...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(total) => "~${total} 公里";

  static String m3(timeLeft) => "以 ${timeLeft}结尾";

  static String m4(message) => "Error: ${message}";

  static String m5(time) => "在 ${time}期满";

  static String m6(total) => ">${total} 公里";

  static String m7(hour) => "${hour} 小时前";

  static String m8(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static String m9(size) => "档案大小上限： ${size} MB";

  static String m10(minute) => "${minute} 分钟钱";

  static String m11(month) => "${month} 个月前";

  static String m12(itemCount) => "${itemCount} 件商品";

  static String m13(price) => "选项总数： ${price}";

  static String m14(percent) => "出售${percent}%";

  static String m15(second) => "${second} 秒前";

  static String m16(totalCartQuantity) => "购物车, ${totalCartQuantity} 件商品";

  static String m17(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m18(total) => "${total} 个产品";

  static String m19(date) => "有效期至 ${date}";

  static String m20(message) => "警告: ${message}";

  static String m21(length) => "我们找到 ${length} 个产品";

  static String m22(week) => "周 ${week}";

  static String m23(year) => "${year} 年前";

  static String m24(total) => "您已指定订单 #${total}";
