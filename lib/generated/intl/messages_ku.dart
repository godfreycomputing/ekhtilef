...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} ڕۆژ پێش ئێستا";

  static String m3(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m4(message) => "هەڵە: ${message}";

  static String m5(time) => "بەسەردەچێت لە ${time}";

  static String m7(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m10(minute) => "${minute} خولەك پێش ئێستا";

  static String m12(itemCount) => "${itemCount} ئایتم";

  static String m13(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m14(percent) => "داشکاندن ${percent} %";

  static String m15(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m18(total) => "${total} بەرهەمەکان";

  static String m19(date) => "گونجاوە تا ${date}";

  static String m20(message) => "ئاگاداری: ${message}";

  static String m21(length) => "${length} بەرهەم دۆزرایەوە";
