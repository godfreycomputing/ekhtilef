...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(timeLeft) => "${timeLeft} تەواو دەبێت";

  static m4(message) => "هەڵە: ${message}";

  static m5(time) => "بەسەردەچێت لە ${time}";

  static m7(hour) => "${hour} کاتژمێر پێش ئێستا";

  static m8(message) => "کێشەیەک هەیە لەگەڵ سێرڤس لەکاتی داواکردنی داتا، تکایە پەیوەندی بکە بە سەرپەرشتیارەوى ئەپەکە بۆ چارەسەرکردنی کێشەکان: ${message}";

  static m10(minute) => "${minute} خولەك پێش ئێستا";

  static m12(itemCount) => "${itemCount} ئایتم";

  static m13(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static m14(percent) => "داشکاندن ${percent} %";

  static m15(second) => "${second} چرکە پێش ئێستا";

  static m16(totalCartQuantity) => "سەبەتەى کڕین, ${totalCartQuantity} ئایتم";

  static m17(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static m18(total) => "${total} بەرهەمەکان";

  static m19(date) => "گونجاوە تا ${date}";

  static m20(message) => "ئاگاداری: ${message}";

  static m21(length) => "${length} بەرهەم دۆزرایەوە";
