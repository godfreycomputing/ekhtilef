...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "Пре ${day} Данa";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Завршава се у${timeLeft}";

  static String m4(message) => "Fehler: ${message}";

  static String m5(time) => "Истиче ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "Пре ${hour} Сати";
  ...
  static String m9(size) => "Maksimalna veličina datoteke: ${size} MB";

  static String m10(minute) => "Пре ${minute} Minuten";

  static String m11(month) => " Prije${month} mjeseci";

  static String m12(itemCount) => "${itemCount} Ставка";

  static String m13(price) => "Укупно опција: ${price}";

  static String m14(percent) => "Распродај ${percent} %";

  static String m15(second) => "Пре ${second} Минута";

  static String m16(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m17(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m18(total) => "${total} proizvoda";

  static String m19(date) => "Датум истека ${date}";

  static String m20(message) => "упозорење: ${message}";

  static String m21(length) => "Пронашли смо производе";

  static String m22(week) => " ${week}. Sedmica";

  static String m23(year) => " Prije${year} godina";

  static String m24(total) => "Dodijelili ste narudžbi br.${total}";
