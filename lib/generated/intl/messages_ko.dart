...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(timeLeft) => " ${timeLeft}로 끝남";

  static m4(message) => "오류 : ${message}";

  static m5(time) => " ${time}후 만료";

  static m6(total) => ">${total} km";

  static m7(hour) => "${hour} 시간 전";

  static m8(message) => "데이터를 요청하는 동안 앱에 문제가 있습니다. 문제를 해결하려면 관리자에게 문의하세요. ${message}";

  static m9(size) => "최대 파일 크기 : ${size} MB";

  static m10(minute) => "${minute} 분 전";

  static m11(month) => "${month} 개월 전";

  static m12(itemCount) => "${itemCount} 항목";

  static m13(price) => "총 옵션 : ${price}";

  static m14(percent) => "판매 ${percent} %";

  static m15(second) => "${second} 초 전";

  static m16(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static m17(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static m18(total) => "${total} 제품";

  static m19(date) => " ${date}까지 유효";

  static m20(message) => "경고 : ${message}";

  static m21(length) => " ${length} 개의 제품을 찾았습니다.";

  static m22(week) => "주 ${week}";

  static m23(year) => "${year} 년 전";

  static m24(total) => "주문 번호${total}에 할당했습니다.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "audioDetected" : MessageLookupByLibrary.simpleMessage("오디오 항목이 감지되었습니다. 오디오 플레이어에 추가 하시겠습니까?"),
    ...
    "cantPickDateInThePast" : MessageLookupByLibrary.simpleMessage("과거 날짜는 허용되지 않습니다."),
    ...
    "chatViaFacebook" : MessageLookupByLibrary.simpleMessage("Facebook Messenger를 통해 채팅"),
    ...
    "commentSuccessfully" : MessageLookupByLibrary.simpleMessage("성공적으로 댓글을 달았습니다. 댓글이 승인 될 때까지 기다려주세요."),
    "confirm" : MessageLookupByLibrary.simpleMessage("확인"),
    "confirmClearTheCart" : MessageLookupByLibrary.simpleMessage("카트를 비우시겠습니까?"),
    "confirmDeleteItem" : MessageLookupByLibrary.simpleMessage("이 항목을 삭제 하시겠습니까?"),
    ...
    "createNewPostSuccessfully" : MessageLookupByLibrary.simpleMessage("게시물이 초안으로 작성되었습니다. 관리자 사이트를 살펴보십시오."),
    ...
    "deliveryNotificationError" : MessageLookupByLibrary.simpleMessage("데이터가 없습니다.\n이 주문은 삭제되었습니다."),
    ...
    "emailDoesNotExist" : MessageLookupByLibrary.simpleMessage("입력 한 이메일 계정이 존재하지 않습니다. 다시 시도하십시오."),
    ...
    "emptySearch" : MessageLookupByLibrary.simpleMessage("아직 항목을 검색하지 않았습니다. 지금 시작하겠습니다. 저희가 도와 드리겠습니다."),
    ...
    "endDateCantBeAfterFirstDate" : MessageLookupByLibrary.simpleMessage("첫 번째 날짜 이후의 날짜를 선택하세요."),
    "endsIn" : m3,
    ...
    "enterYourEmailOrUsername" : MessageLookupByLibrary.simpleMessage("이메일 또는 사용자 이름을 입력하십시오."),
    ...
    "enterYourPhoneNumber" : MessageLookupByLibrary.simpleMessage("전화 번호를 입력하십시오"),
    "error" : m4,
    "errorEmailFormat" : MessageLookupByLibrary.simpleMessage("유효한 이메일 주소를 입력하세요."),
    "errorPasswordFormat" : MessageLookupByLibrary.simpleMessage("8 자 이상의 비밀번호를 입력하세요."),
    ...
    "noFileToDownload" : MessageLookupByLibrary.simpleMessage("다운로드 할 파일이 없습니다."),
    ...
    "orderStatusCanceledReversal" : MessageLookupByLibrary.simpleMessage("취소 된 취소"),
    ...
    "pleaseSignInBeforeUploading" : MessageLookupByLibrary.simpleMessage("파일을 업로드하기 전에 계정에 로그인하십시오."),
    ...
    "postSuccessfully" : MessageLookupByLibrary.simpleMessage("게시물이 성공적으로 작성되었습니다."),
    ...
    "productCreateReview" : MessageLookupByLibrary.simpleMessage("검토 후 제품이 표시됩니다."),
    ...
    "refundOrderFailed" : MessageLookupByLibrary.simpleMessage("주문에 대한 환불 요청이 실패했습니다."),
    "refundOrderSuccess" : MessageLookupByLibrary.simpleMessage("주문에 대한 환불을 성공적으로 요청하십시오!"),
    ...
    "requestTooMany" : MessageLookupByLibrary.simpleMessage("짧은 시간에 너무 많은 코드를 요청했습니다. 나중에 다시 시도 해주십시오."),
    ...
    "userExists" : MessageLookupByLibrary.simpleMessage("이 사용자 이름/이메일은 사용할 수 없습니다."),
    ...
    "youCanOnlyOrderSingleStore" : MessageLookupByLibrary.simpleMessage("단일 매장에서만 구매할 수 있습니다."),
