...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(timeLeft) => " ${timeLeft}로 끝남";

  static String m4(message) => "오류 : ${message}";

  static String m5(time) => " ${time}후 만료";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} 시간 전";

  static String m8(message) =>
      "데이터를 요청하는 동안 앱에 문제가 있습니다. 문제를 해결하려면 관리자에게 문의하세요. ${message}";

  static String m9(size) => "최대 파일 크기 : ${size} MB";

  static String m10(minute) => "${minute} 분 전";

  static String m11(month) => "${month} 개월 전";

  static String m12(itemCount) => "${itemCount} 항목";

  static String m13(price) => "총 옵션 : ${price}";

  static String m14(percent) => "판매 ${percent} %";

  static String m15(second) => "${second} 초 전";

  static String m16(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m17(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m18(total) => "${total} 제품";

  static String m19(date) => " ${date}까지 유효";

  static String m20(message) => "경고 : ${message}";

  static String m21(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m22(week) => "주 ${week}";

  static String m23(year) => "${year} 년 전";

  static String m24(total) => "주문 번호${total}에 할당했습니다.";
