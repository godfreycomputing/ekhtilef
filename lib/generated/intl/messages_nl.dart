...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} dagen geleden";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Eindigt over ${timeLeft}";

  static String m4(message) => "Fout: ${message}";

  static String m5(time) => "Verloopt over ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} uur geleden";
  ...
  static String m9(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m10(minute) => "${minute} minuten geleden";

  static String m11(month) => "${month} maanden geleden";

  static String m12(itemCount) => "${itemCount} items";

  static String m13(price) => "Opties totaal: ${price}";

  static String m14(percent) => "Verkoop ${percent} %";

  static String m15(second) => "${second} seconden geleden";

  static String m16(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m17(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m18(total) => "${total} producten";

  static String m19(date) => "Geldig tot ${date}";

  static String m20(message) => "Waarschuwing: ${message}";

  static String m21(length) => "We hebben ${length} producten gevonden";

  static String m22(week) => "Week ${week}";

  static String m23(year) => "${year} jaar geleden";

  static String m24(total) => "Je hebt toegewezen aan bestelling #${total}";
