...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} днів тому";

  static String m2(total) => "~${total} км";

  static String m3(timeLeft) => "Закінчується через ${timeLeft}";

  static String m4(message) => "Помилка: ${message}";

  static String m5(time) => "Термін дії закінчується через ${time}";

  static String m6(total) => ">${total} км";

  static String m7(hour) => "${hour} годин тому";
  ...
  static String m9(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m10(minute) => "${minute} хвилин тому";

  static String m11(month) => "${month} місяців тому";

  static String m12(itemCount) => "${itemCount} елементів";

  static String m13(price) => "Всього варіантів: ${price}";

  static String m14(percent) => "Продаж ${percent}%";

  static String m15(second) => "${second} секунд тому";

  static String m16(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m17(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m18(total) => "${total} продуктів";

  static String m19(date) => "Діє до ${date}";

  static String m20(message) => "Попередження: ${message}";

  static String m21(length) => "Ми знайшли ${length} продуктів";

  static String m22(week) => "Тиждень ${week}";

  static String m23(year) => "${year} років тому";

  static String m24(total) => "Ви призначили замовлення №${total}";
