...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} dni temu";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Kończy się za ${timeLeft}";

  static String m4(message) => "Błąd: ${message}";

  static String m5(time) => "Wygasa za ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} godz. Temu";
  ...
  static String m9(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m10(minute) => "${minute} min temu";

  static String m11(month) => "${month} miesięcy temu";

  static String m12(itemCount) => "${itemCount} elementów";

  static String m13(price) => "Łącznie opcje: ${price}";

  static String m14(percent) => "Wyprzedaż ${percent}%";

  static String m15(second) => "${second} sekundy temu";

  static String m16(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m17(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m18(total) => "${total} produktów";

  static String m19(date) => "Ważne do ${date}";

  static String m20(message) => "Ostrzeżenie: ${message}";

  static String m21(length) => "Znaleźliśmy ${length} produktów";

  static String m22(week) => "Tydzień ${week}";

  static String m23(year) => "${year} lat temu";

  static String m24(total) => "Przypisałeś do zamówienia nr${total}";
