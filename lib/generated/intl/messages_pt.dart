...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(day) => "${day} dias atrás";

  static String m2(total) => "~${total} km";

  static String m3(timeLeft) => "Ends in ${timeLeft}";

  static String m4(message) => "Erro: ${message}";

  static String m5(time) => "Expirando em ${time}";

  static String m6(total) => ">${total} km";

  static String m7(hour) => "${hour} horas atrás";
  ...
  static String m9(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m10(minute) => "${minute} minutos atrás";

  static String m11(month) => "${month} meses atrás";

  static String m12(itemCount) => "${itemCount} itens";

  static String m13(price) => "Opções totais: ${price}";

  static String m14(percent) => "Desconto ${percent} %";

  static String m15(second) => "${second} segundos atrás";
  ...
  static String m18(total) => "${total} produtos";

  static String m19(date) => "Válido até ${date}";

  static String m20(message) => "Atenção: ${message}";

  static String m21(length) => "Encontramos ${length} produtos";

  static String m22(week) => "Semana ${week}";

  static String m23(year) => "${year} anos atrás";

  static String m24(total) => "Você atribuiu o pedido nº${total}";
