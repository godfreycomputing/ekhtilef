...
class AppModel with ChangeNotifier {
  ...
  AppModel([String? lang, bool isBuilder = false]) {
    _langCode = lang ?? kAdvanceConfig['DefaultLanguage'];
    getPrefConfig(lang: _langCode, isBuilder: true);
  ...
  Future<bool> getPrefConfig({String? lang, bool isBuilder = false}) async {
    try {
      if (Config().isBuilder || isBuilder) {
        return true;
      }
