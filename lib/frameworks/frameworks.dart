...
import 'wordpress/presentation/widgets/blog_list_layout.dart';
...
//Sync cart to website
  ...
  Widget renderSearchScreen() {
    return ChangeNotifierProvider<SearchModel>(
      ...
      builder: (context, _) {
        return const SearchScreen(key: Key('search'));
      },
    );
  }
  ...
  Widget renderCommentField(dynamic postId) => const SizedBox();

  Widget renderRelatedBlog({dynamic categoryId, required kBlogLayout type}) =>
      const SizedBox();
